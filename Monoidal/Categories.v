 ...
 ***************************************************************************)
 ...
 Lemma leftunitor_nat_z_iso {C : category} (M : monoidal C)
   : nat_z_iso
       (leftwhiskering_functor M (bifunctor_leftid M) (bifunctor_leftcomp M) I_{M})
       (functor_identity C).
 Proof.
   use make_nat_z_iso.
   - use make_nat_trans.
 ...
 Definition rightunitor_nat_z_iso {C : category} (M : monoidal C)
   : nat_z_iso
       (rightwhiskering_functor M (bifunctor_rightid M) (bifunctor_rightcomp M) I_{M})
       (functor_identity C).
 Proof.
   use make_nat_z_iso.
   - use make_nat_trans.
 ...
 Section EquivalenceFromTensorWithUnit.
   ...
   Definition ladjunction_data_from_tensor_with_unit
     : adjunction_data C C.
   Proof.
     exists (leftwhiskering_functor M (bifunctor_leftid M) (bifunctor_leftcomp M)  I_{M}).
   ...
   Definition radjunction_data_from_tensor_with_unit
     : adjunction_data C C.
   Proof.
     exists (rightwhiskering_functor M (bifunctor_rightid M) (bifunctor_rightcomp M)  I_{M}).
     exists (functor_identity C).
     use tpair.
   ...
   Lemma leftwhiskering_fullyfaithful
     : fully_faithful (leftwhiskering_functor M (bifunctor_leftid M) (bifunctor_leftcomp M)  I_{M}).
   Proof.
   ...
   Lemma rightwhiskering_fullyfaithful
     : fully_faithful (rightwhiskering_functor M (bifunctor_rightid M) (bifunctor_rightcomp M)  I_{M}).
   Proof.
     apply fully_faithful_from_equivalence.
   ...
   Lemma leftwhiskering_faithful
     : faithful (leftwhiskering_functor M (bifunctor_leftid M) (bifunctor_leftcomp M)  I_{M}).
   Proof.
     exact (pr2 (fully_faithful_implies_full_and_faithful _ _ _ leftwhiskering_fullyfaithful)).
   Defined.
 
   Lemma rightwhiskering_faithful
     : faithful (rightwhiskering_functor M (bifunctor_rightid M) (bifunctor_rightcomp M) I_{M}).
   Proof.
 ...
 Section UnitorsCoincide.
   ...
   Proof.
     ...
     set (luixy := functor_on_z_iso (rightwhiskering_functor M (bifunctor_rightid M) (bifunctor_rightcomp M) y) luix).
 ...
 Section MonoidalLaws.
   ...
   Proof.
     ...
     set (ruiyx := functor_on_z_iso (leftwhiskering_functor M (bifunctor_leftid M) (bifunctor_leftcomp M) x) ruiy).
