...
Coercion Coalg_carrier (X : Coalgebra_data) : C := pr1 X.
...
Coercion Coalgebra_data_from_Coalgebra (X : Coalgebra) : Coalgebra_data := pr1 X.
...
Coercion mor_from_Coalgebra_mor {X Y : Coalgebra} (f : Coalgebra_mor X Y)
  : X --> Y := pr1 f.
